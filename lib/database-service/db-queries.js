...
module.exports.createNewProfile = function(panelData, id) {
    const {
        name,
        birth,
        dead,
    ...
    const query = `INSERT INTO UserPanels (User_ID, Name, Birth, Dead, Sentence, Text)
        VALUES ('${id}', '${name}', '${birth}', '${dead}', '${sentence}', '${text}')`;
    return  _execute(query);
}
